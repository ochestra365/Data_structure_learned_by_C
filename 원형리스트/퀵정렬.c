...
1. 피봇[pivot]이라는 것을 만들어야 한다. 배열에서 피봇은 우측으로 이동하는 경향을 가지고 있다.
...
int main() {
	...
	//배열의 첫번 째 인덱스와 마지막 인덱스를 실인수로 가진다.
	return 0;
}
